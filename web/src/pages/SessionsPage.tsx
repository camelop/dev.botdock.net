 ...
 *  library. Path data sourced verbatim from simple-icons.org (CC0):
 *    - claude-code: simple-icons `claude.svg`, Anthropic's Claude mark
 *    - codex: simple-icons `openai.svg`, OpenAI's rosette mark
 *    - generic-cmd: lucide-style terminal `>_` (no upstream brand to use).
 *  Both brand marks render here as nominative-use indicators of agent
 *  compatibility, which is the use case both Anthropic's trademark
 *  policy and OpenAI's brand guidelines explicitly permit. */
